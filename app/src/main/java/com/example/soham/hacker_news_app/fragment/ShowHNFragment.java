...
public class ShowHNFragment extends Fragment {
    ...
    public static ShowHNFragment newInstance(String param1, String param2) {
        ShowHNFragment fragment = new ShowHNFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                if (dy > 0) {
                    ...
                    if (!loading && (totalItemCount - visibleItemCount) <= (pastVisiblesItems + visibleThreshold) && mayScroll) {
                        ...
                        for (int i=start ; i<end ; i++) {
                            try {
                                new getShowStory(getActivity(), i).execute(baseUrl +jarr.get(i).toString() + endUrl);
                            } catch (Exception e) {
                                mayScroll = false;
                            }
                        }
        ...
        try {
            new getShowStories(getActivity(), jarr).execute("https://hacker-news.firebaseio.com/v0/showstories.json");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    class getShowStories extends AsyncTask<String, Void, JSONArray> {

        Activity context;
        JSONArray result;

        public getShowStories(){}

        public getShowStories(Activity context, JSONArray result) {
        ...
        protected JSONArray doInBackground(String... urls) {
            ...
            try {
                //URL url = new URL("https://hacker-news.firebaseio.com/v0/showstories.json");
    ...
    class getShowStory extends AsyncTask<String, Void, JSONObject> {
        ...
        public getShowStory(Activity context, int index) {
            this.context = context;
            this.index = index;
        }
